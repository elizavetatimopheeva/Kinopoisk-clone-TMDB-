...
class NewsWidgetUpcoming extends StatefulWidget {
  const NewsWidgetUpcoming({Key? key}) : super(key: key);

  @override
  _NewsWidgetUpcomingState createState() => _NewsWidgetUpcomingState();
}
